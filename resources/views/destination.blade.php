    ...
    <div class="atas">
        <div class="searchDiv">
            <form action="" method="post" class="searchForm h-100 w-100 d-flex justify-content-start align-items-center">
                @csrf
                {{-- <input type="text" name="searchBox" id="searchBox" class="cobasearchbox" placeholder="Search destination for your event" style="display: none;"> --}}
                <input type="text" name="searchBox" id="searchBox" class=" cobasearchbox searchBox w-100 " placeholder="Search destination for your event">
        ...
        <div class="categories">
            <button type="submit" class="categoriesCard allbtn">
                All
            </button>
