        ...
        <div class="container d-flex flex-row justify-content-center align-items-center" style="display: none">
            <div class="left-side d-flex flex-column justify-content-center align-items-center">
                <div class="change-container d-flex flex-row">
                    <div id="frame" class="img-container  rounded-circle" style="background-image: url({{ asset('/assets/img/PantiAsuhan.png') }})"></div>
            ...
            <div class="right-side d-flex flex-column justify-content-center align-items-center">
                <div class="box d-flex flex-column">
                    <div class="change-content">
                        <h3>Username</h3>
                        <input type="text" class="change-input rounded" placeholder="Username">
                    </div>

                    <div class="change-content">
                        <h3>Email</h3>
                        <input type="email" class="change-input rounded" placeholder="Email">
                    </div>

                    <div class="change-content">
                        <h3>Phone Number</h3>
                        <input type="text" class="change-input rounded" placeholder="Phone Number">
                    </div>

                    <div class="change-content">
                        <h3>Address</h3>
                        <textarea class="rounded" name="change-address" id="change-address" placeholder="Address"></textarea>
                    </div>
                </div>
            </div>
        </div>
