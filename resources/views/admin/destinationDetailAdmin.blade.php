@section('css')
    <link rel="stylesheet" href="assets/css/destinationDetailAdmin.css">
@endsection
...
<div class="padding">
    <div class="container d-flex flex-column justify-content-center align-items-center">
        <div class="destination-image" style="background-image: url({{ asset('/assets/img/PantiAsuhan.png') }})"></div>
        <div class="destination-name">
            Panti Asuhan Bhakti Kasih
        </div>
        <div class="destination-person d-flex flex-row align-items-center">
            ...
            <p><b>255 orang</b> penerima bantuan</p>
        </div>
        ...
        <div class="button-container d-flex flex-row">
            <button class="d-flex flex-row align-items-center justify-content-center button-one">
